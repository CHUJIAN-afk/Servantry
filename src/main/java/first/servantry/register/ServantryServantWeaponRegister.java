...
public class ServantryServantWeaponRegister {
    ...
    public static final DeferredItem<Item> SurveyDroneRemote =
            Register.register(SERVANT_WEAPON, "survey_drone_remote", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.OreScout)
                    ...
                    .servant(ServantryAttachmentEntityRegister.OreScout, "Survey Drone", "矿勘无人机")
    ...
    public static final DeferredItem<Item> FairyBell =
            Register.register(SERVANT_WEAPON, "fairy_bell", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.ScavengerFairy)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.ScavengerFairy, "Scavenger Fairy", "拾荒妖精")
    ...
    public static final DeferredItem<Item> BladeStaff =
            Register.register(SERVANT_WEAPON, "blade_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.EnchantedThrowingKnives)
                            .damage(0.6f)
                            .armorPierce(7.5f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.EnchantedThrowingKnives, "Enchanted Throwing Knives", "附魔飞刀")
    ...
    public static final DeferredItem<Item> RainCloudStaff =
            Register.register(SERVANT_WEAPON, "rain_cloud_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.Cloud)
                            .damage(3f)
                            .sentryServant()
                    ...
                    .servant(ServantryAttachmentEntityRegister.Cloud, "Rain Cloud", "雨云")
    ...
    public static final DeferredItem<Item> OpticStaff =
            Register.register(SERVANT_WEAPON, "optic_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.Twins)
                            .damage(2.4f)
                            .knockback(0.2f)
                    ...
                    .servant(ServantryAttachmentEntityRegister.Twins, "Twins", "双子魔眼")
                    .build();
    /**
     * 致命球法杖 - 召唤致命球仆从
     */
    public static final DeferredItem<Item> DeadlySphereStaff =
            Register.register(SERVANT_WEAPON, "deadly_sphere_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.DeadlySphere)
                            .damage(5.5f)
                            .knockback(0.2f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .properties(properties -> properties.rarity(Rarity.RARE))
                    ...
                    .servant(ServantryAttachmentEntityRegister.DeadlySphere, "Deadly Sphere", "致命球")
                    .build();
    /**
     * 脉冲炮塔遥控装置
     */
    public static final DeferredItem<Item> PulseTurretRemote =
            Register.register(SERVANT_WEAPON, "pulse_turret_remote", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.PulseTurret)
                            .damage(15f)
                            .sentryServant()
                    ...
                    .servant(ServantryAttachmentEntityRegister.PulseTurret, "Pulse Turret", "脉冲炮塔")
    ...
    public static final DeferredItem<Item> TempestStaff =
            Register.register(SERVANT_WEAPON, "tempest_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.Sharknado)
                            .damage(5f)
                            .knockback(0.2f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .properties(properties -> properties.rarity(Rarity.RARE))
                    ...
                    .servant(ServantryAttachmentEntityRegister.Sharknado, "Sharknado", "鲨鱼龙卷")
                    .build();
    /**
     * 泰拉棱镜 - 召唤泰拉棱镜仆从
     */
    public static final DeferredItem<Item> TerraPrism =
            Register.register(SERVANT_WEAPON, "terraprism", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.TerraPrism)
                            .damage(9f)
                            .knockback(0.4f)
                            .sound(ServantrySoundRegister.UseTerraprism)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.TerraPrism, "Terraprism", "泰拉棱镜")
    ...
    public static final DeferredItem<Item> BallistaRod =
            Register.register(SERVANT_WEAPON, "ballista_rod", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.Ballista)
                            .damage(3f)
                            .knockback(0.47f)
                            .sentryServant()
                            .sound(ServantrySoundRegister.UseBallistaStaff)
    ...
    public static final DeferredItem<Item> BallistaCane =
            Register.register(SERVANT_WEAPON, "ballista_cane", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.Ballista)
                            .damage(7.4f)
                            .knockback(0.47f)
                            .sentryServant()
                            .sound(ServantrySoundRegister.UseBallistaStaff)
    ...
    public static final DeferredItem<Item> BallistaStaff =
            Register.register(SERVANT_WEAPON, "ballista_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.Ballista)
                            .damage(15.6f)
                            .knockback(0.47f)
                            .sentryServant()
                            .sound(ServantrySoundRegister.UseBallistaStaff)
                    ...
                    .servant(ServantryAttachmentEntityRegister.Ballista, "Ballista", "弩车")
                    .tooltip(1, "A slow but high damage tower that shoots piercing bolts", "速度缓慢但伤害力极高的防御塔，可以射出穿透性箭矢")
                    .build();
    /**
     * 缥缈星核法杖 - 召唤缥缈星核仆从
    ...
    public static final DeferredItem<Item> EtherealStellarCoreStaff =
            Register.register(SERVANT_WEAPON, "ethereal_stellar_core_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.EtherealStellarCore)
                            .damage(10.0f)
                            .knockback(0.2f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.EtherealStellarCore, "Ethereal Stellar Core", "缥缈星核")
    ...
    public static final DeferredItem<Item> StardustCellStaff =
            Register.register(SERVANT_WEAPON, "stardust_cell_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.StardustCell)
                            .damage(6f)
                            .knockback(0.2f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .properties(properties -> properties.rarity(Rarity.EPIC))
                    ...
                    .servant(ServantryAttachmentEntityRegister.StardustCell, "Stardust Cell", "星尘细胞")
    ...
    public static final DeferredItem<Item> StardustDragonStaff =
            Register.register(SERVANT_WEAPON, "stardust_dragon_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.StardustDragon)
                            .damage(4f)
                            .knockback(0.2f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.StardustDragon, "Stardust Dragon", "星尘之龙")
    ...
    public static final DeferredItem<Item> MoonPortalStaff =
            Register.register(SERVANT_WEAPON, "moon_portal_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.MoonPortal)
                            .damage(10)
                            .knockback(0.75f)
                            .sentryServant()
                    ...
                    .servant(ServantryAttachmentEntityRegister.MoonPortal, "Moon Portal", "月亮传送门")
                    .build();
    /**
     * 七彩水晶法杖
     */
    public static final DeferredItem<Item> RainbowCrystalStaff =
            Register.register(SERVANT_WEAPON, "rainbow_crystal_staff", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.RainbowCrystal)
                            .damage(13)
                            .knockback(0.75f)
                            .sentryServant()
                            .sound(ServantrySoundRegister.UseMoonPortalStaff)
                    ...
                    .servant(ServantryAttachmentEntityRegister.RainbowCrystal, "Rainbow Crystal", "七彩水晶")
    ...
    public static final DeferredItem<Item> InfiniteScabbard =
            Register.register(SERVANT_WEAPON, "infinite_scabbard", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.InfiniteShadow)
                            .sound(ServantrySoundRegister.UseTerraprism)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.InfiniteShadow, "Infinite Shadow", "无限之影")
    ...
    public static final DeferredItem<Item> VoidEaterMarionette =
            Register.register(SERVANT_WEAPON, "void_eater_marionette", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.VoidEater)
                            .damage(11f)
                            .knockback(0.5f)
                            .sound(ServantrySoundRegister.UseServantWeapon)
                            .summon((weapon, player) -> {
                    ...
                    .servant(ServantryAttachmentEntityRegister.VoidEater, "Void Eater", "虚空吞噬者")
    ...
    public static final DeferredItem<Item> ThundercloudBonsai =
            Register.register(SERVANT_WEAPON, "thundercloud_bonsai", () -> new ServantWeaponItemBuilder<>(ServantryAttachmentEntityRegister.SuperPeashooter)
                            .damage(12f)
                            .knockback(0)
                            .sentryServant()
                            .sound(ServantrySoundRegister.UseMoonPortalStaff)
                    ...
                    .servant(ServantryAttachmentEntityRegister.SuperPeashooter, "Super Peashooter", "超级电能豌豆射手")
