...
public class ServantryLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        entry("modid.servantry")
                .en("Servantry")
                .zh("仆从学");
        entry("itemStack.servantry.tooltip.set_bonus_title")
                .en("Set Bonus:")
                .zh("套装效果:");
        entry("itemStack.servantry.tooltip.damage")
                .en(" Summon Damage")
                .zh(" 召唤伤害");
        entry("itemStack.servantry.tooltip.knockback")
                .en(" Knockback")
                .zh(" 击退强度");
        entry("itemStack.servantry.tooltip.summon")
                .en("Summons %s to fight for you")
                .zh("召唤 %s 为你而战");
        entry("itemStack.servantry.tooltip.slots")
                .en("Servant Slots: %s / %s")
                .zh("仆从栏位: %s / %s");
        entry("itemStack.servantry.tooltip.remove_all")
        ...
        entry("curios.curios.accessories")
                .en("Accessories")
                .zh("配饰");
        entry("itemStack.servantry.necromantic_scroll")
                .en("Necromantic Scroll")
                .zh("死灵卷轴");
        entry("itemStack.servantry.papyrus_scarab")
                .en("Papyrus Scarab")
                .zh("甲虫莎草纸");
        entry("itemStack.servantry.pygmy_necklace")
                .en("Pygmy Necklace")
                .zh("矮人项链");
        entry("itemStack.servantry.hercules_beetle")
                .en("Hercules Beetle")
                .zh("大力士甲虫");
        entry("itemStack.servantry.summoner_emblem")
                .en("Summoner Emblem")
                .zh("召唤师徽章");
        entry("itemStack.servantry.apprentices_scarf")
                .en("Apprentice's Scarf")
                .zh("学徒围巾");
        entry("itemStack.servantry.huntresses_buckler")
                .en("Huntress's Buckler")
                .zh("女猎人圆盾");
        entry("itemStack.servantry.monks_belt")
                .en("Monk's Belt")
                .zh("武僧腰带");
        entry("itemStack.servantry.squires_shield")
                .en("Squire's Shield")
                .zh("侍卫护盾");
        // ===================== 护甲 =====================
        entry("itemStack.servantry.hallowed_helmet")
                .en("Hallowed Helmet")
                .zh("神圣兜帽");
        entry("itemStack.servantry.hallowed_chestplate")
                .en("Hallowed Chestplate")
                .zh("神圣板甲");
        entry("itemStack.servantry.hallowed_leggings")
                .en("Hallowed Leggings")
                .zh("神圣护胫");
        entry("itemStack.servantry.hallowed_boots")
                .en("Hallowed Boots")
                .zh("神圣战靴");
        entry("itemStack.servantry.hallowed.set.1")
                .en("+2 Servant Slots")
                .zh("+2 仆从栏");
        entry("itemStack.servantry.hallowed.set.2")
                .en("+15% Servant Damage")
                .zh("+15% 仆从伤害");
        entry("itemStack.servantry.hallowed.set.3")
                .en("+4 Servant Armor Penetration")
                .zh("+4 仆从护甲穿透");
        entry("itemStack.servantry.hallowed.set.4")
        ...
        entry("effect.servantry.cursed_flame")
                ...
                .zh("诅咒焰");
        // 长效和强效药水
        entry("itemStack.minecraft.potion.effect.obsession")
                .en("Potion of Obsession")
                .zh("着魔药水");
        entry("itemStack.minecraft.splash_potion.effect.obsession")
                .en("Splash Potion of Obsession")
                .zh("喷溅型着魔药水");
        entry("itemStack.minecraft.lingering_potion.effect.obsession")
                .en("Lingering Potion of Obsession")
                .zh("滞留型着魔药水");
        entry("itemStack.minecraft.tipped_arrow.effect.obsession")
                .en("Arrow of Obsession")
                .zh("着魔之箭");
        entry("itemStack.minecraft.potion.effect.long_obsession")
                .en("Potion of Obsession")
                .zh("着魔药水");
        entry("itemStack.minecraft.splash_potion.effect.long_obsession")
                .en("Splash Potion of Obsession")
                .zh("喷溅型着魔药水");
        entry("itemStack.minecraft.lingering_potion.effect.long_obsession")
                .en("Lingering Potion of Obsession")
                .zh("滞留型着魔药水");
        entry("itemStack.minecraft.tipped_arrow.effect.long_obsession")
                .en("Arrow of Obsession")
                .zh("着魔之箭");
        entry("itemStack.minecraft.potion.effect.strong_obsession")
                .en("Potion of Obsession")
                .zh("着魔药水");
        entry("itemStack.minecraft.splash_potion.effect.strong_obsession")
                .en("Splash Potion of Obsession")
                .zh("喷溅型着魔药水");
        entry("itemStack.minecraft.lingering_potion.effect.strong_obsession")
                .en("Lingering Potion of Obsession")
                .zh("滞留型着魔药水");
        entry("itemStack.minecraft.tipped_arrow.effect.strong_obsession")
                .en("Arrow of Obsession")
                .zh("着魔之箭");
        // JEI 兼容
