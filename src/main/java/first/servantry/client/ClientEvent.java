...
public class ClientEvent {
    ...
    public static void register(EntityRenderersEvent.RegisterRenderers event) {
        ...
        AttachmentEntityRenderDispatcher.register(ServantryAttachmentEntityRegister.ChlorophyteCrystal.get(), new ChlorophyteCrystalRenderer());
        ...
        AttachmentEntityRenderDispatcher.register(ServantryAttachmentEntityRegister.ChlorophyteCrystalProjectile.get(), new ChlorophyteCrystalProjectileRenderer());
        AttachmentEntityRenderDispatcher.register(ServantryAttachmentEntityRegister.ZenithProjectile.get(), new ZenithProjectileRenderer());
        AttachmentEntityRenderDispatcher.register(ServantryAttachmentEntityRegister.CustomLaserProjectile.get(), new CustomLaserProjectileRenderer());
        AttachmentEntityRenderDispatcher.register(ServantryAttachmentEntityRegister.RainbowCrystalProjectile.get(), new RainbowCrystalProjectileRenderer());
        AttachmentEntityRenderDispatcher.register(ServantryAttachmentEntityRegister.GodFlameProjectile.get(), new GodFlameProjectileRenderer());
